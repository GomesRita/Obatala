...
{
    /**
     * Caso de validação pura: não precisa mockar nada do WP porque o
     * método retorna antes de tocar em qualquer função externa.
     *
     * @dataProvider invalidStepIdProvider
     */
    public function test_save_metadata_returns_false_for_invalid_step_id($invalid_step_id): void
    {
        // error_log é chamado no caminho de erro; stubamos para não
        // gerar ruído/warning durante o teste.
    ...
    public function test_save_metadata_persists_when_data_is_valid(): void
    {
        ...
        // Comportamento esperado: update_post_meta deve ser chamado
        // exatamente uma vez, para o step_id 42.
